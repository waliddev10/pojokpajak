...
class BupotPph21Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.bupot.bupot-pph21.index');
    }
    ...
    public function show($bupotPph21)
    {
        ...
        return view('pages.bupot.bupot-pph21.show', compact('item'));
    }
    ...
    {
        $directory = '/app/public/bukti-potong/pph21/' . $bupotPph21->masa_pajak;
